    ...
    const cargarStats = async () => {
      try {
        const [resCarrito, resBarberia] = await Promise.all([
          fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://freyes0519901.pythonanywhere.com'}/api/carrito/stats`),
          fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://freyes0519901.pythonanywhere.com'}/api/barberia/stats`)
        ]);
